// Simple seed script using CommonJS for easier execution
require('dotenv').config({ path: '.env.local' })
const mongoose = require('mongoose')
const Challenge = require('../models/Challenge.js').default
  ...
  try {
    ...
    for (const language of languages) {
      ...
      for (let i = 0; i < templates.length; i++) {
        ...
        totalCreated++
        console.log(`✅ Created ${language} challenge ${challengeNumber}: ${template.title}`)
      }
    }
