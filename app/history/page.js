  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-white mb-2">Submission History</h1>
          <p className="text-gray-400">Review your past coding challenges and performance</p>
        </div>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <Link
              href="/challenges"
              className="mt-4 inline-block bg-primary-600 hover:bg-primary-700 text-white px-6 py-3 rounded-lg font-semibold transition-colors"
            >
              Go to Challenges
            </Link>
          </div>
                ...
                <div className="flex items-start justify-between">
                    ...
                    <div className="flex items-center space-x-6 text-sm mt-4">
                      ...
                      {submission.executionTime && (
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-white">{submission.executionTime}ms</span>
                      ...
                      {submission.pointsEarned > 0 && (
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-primary-400 font-semibold">+{submission.pointsEarned} XP</span>
                        </div>
                      )}
                  ...
                  {submission.submissionId && submission.challengeId && (
                    <Link
                      ...
                      className="ml-4 text-primary-400 hover:text-primary-300 font-medium transition-colors"
                    >
                      View Solution →
                    </Link>
                  )}
